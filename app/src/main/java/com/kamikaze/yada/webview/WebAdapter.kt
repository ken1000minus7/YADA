...
class WebAdapter(val context: Context, val people :HashMap<String,String>, val peoplekey: ArrayList<String>) : RecyclerView.Adapter<WebAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int ) {
        ...
        holder.card.setOnClickListener {
            ...
            Log.d("idkmaibi", "idk ${people.size} ${peoplekey.size}")
        }

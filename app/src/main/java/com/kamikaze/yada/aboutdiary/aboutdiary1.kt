 ...
 * Use the [aboutdiary1.newInstance] factory method to
 * create an instance of this fragment.
 */
class aboutdiary1 : Fragment(R.layout.fragment_aboutdiary1) {
    ...
    override fun onCreateView(
        ...
        val next = view.findViewById<ImageButton>(R.id.next1)
    ...
    companion object {
         ...
         * @return A new instance of fragment aboutdiary1.
         */
